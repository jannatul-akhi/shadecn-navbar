...
export default function Sidebar({ activeMenu }) {
  const menus = {
    ...
    Attendance: [
      ...
      { icon: <UserCheck />, label: "Schedule Assignment" },
      { icon: <FileText />, label: "Schedule Preview" },
      { icon: <CheckSquare />, label: "Approvals" },
      { icon: <DollarSign />, label: "Benefit Management" },
      { icon: <FileText />, label: "Transaction Report" },
